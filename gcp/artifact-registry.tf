...
# https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/blob/v57.0.0/modules/artifact-registry/README.md
module "artifact-registry-container" {
  source                 = "git::https://github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v57.0.0"
