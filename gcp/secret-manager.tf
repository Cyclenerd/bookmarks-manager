...
# https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/blob/v57.0.0/modules/secret-manager/README.md
module "secret-manager" {
  source     = "git::https://github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/secret-manager?ref=v57.0.0"
