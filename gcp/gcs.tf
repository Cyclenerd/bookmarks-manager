# https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/blob/v57.0.0/modules/gcs/README.md

# GCS bucket for storing Terraform state
module "gcs-bookmarks-manager-iac" {
  source        = "git::https://github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v57.0.0"
...
module "gcs-bookmarks-manager-backup" {
  source        = "git::https://github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v58.0.0"
  project_id    = module.project.project_id
  prefix        = module.project.project_id
