# https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/blob/v57.0.0/modules/iam-service-account/README.md

# Service Account for the Runners Manager (Cloud Run)
module "service-account-cloud-run-bookmarks-manager" {
  source       = "git::https://github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/iam-service-account?ref=v57.0.0"
